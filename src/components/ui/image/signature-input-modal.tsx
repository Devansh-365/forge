...
import { CreatePngFromBase64 } from "~/lib/create-png-from-base64";
import { AlertCircleIcon, Image, LoaderCircleIcon, Signature, XIcon } from "lucide-react";
import { createBlobUrl } from "~/lib/create-blob-url";
              ...
              >
                {!disableIcon && (
                  <div
                    ...
                    aria-hidden="true"
                  >
                    <Signature className="size-4 rotate-12" />
                  </div>
                )}
