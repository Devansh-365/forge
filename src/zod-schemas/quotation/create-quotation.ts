...
export const createQuotationFieldKeyStringValuesSchema = z.object(
  {
...
export const createQuotationFieldKeyNumberValuesSchema = z.object(
  {
    label: z.string({ invalid_type_error: "Label must be a string" }).min(1, {
      message: "Label cannot be empty",
    }),
  ...
  companyDetails: z.object(
    {
      ...
      metadata: z.array(createQuotationFieldKeyStringValuesSchema),
    },
  ...
  invoiceDetails: z.object(
    {
      ...
      billingDetails: z.array(createQuotationFieldKeyNumberValuesSchema),
    },
  ...
  metadata: z.object(
    {
      ...
      paymentInformation: z.array(createQuotationFieldKeyStringValuesSchema),
    },
